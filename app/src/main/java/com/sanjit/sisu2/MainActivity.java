            ...
            public boolean onOptionsItemSelected (MenuItem item){
                switch (item.getItemId()) {
                    ...
                    case R.id.action_logout:
                        ...
                        Intent intentnot = new Intent(getApplicationContext(), Login.class);
                        intentnot.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);

                        PendingIntent contentIntent = PendingIntent.getActivity(this, REQUEST_CODE, intentnot,PendingIntent.FLAG_IMMUTABLE);
