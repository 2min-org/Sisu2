...
public class nutfrag4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_nutfrag4, container, false);
        viewPager3=view.findViewById(R.id.viewPagerImageSliderNutrition4);

        List<SliderItem> sliderItems=new ArrayList<>();
        sliderItems.add(new SliderItem(R.drawable.oneone));
        sliderItems.add(new SliderItem(R.drawable.onetwo));
        sliderItems.add(new SliderItem(R.drawable.onethree));
        sliderItems.add(new SliderItem(R.drawable.onefour));
        sliderItems.add(new SliderItem(R.drawable.onefive));
        sliderItems.add(new SliderItem(R.drawable.onesix));
