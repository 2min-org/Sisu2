...
public class nutfrag1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_nutfrag1, container, false);
        viewPager3=view.findViewById(R.id.viewPagerImageSliderNutrition);

        List<SliderItem> sliderItems=new ArrayList<>();
        sliderItems.add(new SliderItem(R.drawable.zeroone));
        sliderItems.add(new SliderItem(R.drawable.zerotwo));
        sliderItems.add(new SliderItem(R.drawable.zerothree));
