...
public class nutfrag6 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_nutfrag6, container, false);
        viewPager3=view.findViewById(R.id.viewPagerImageSliderNutrition6);

        List<SliderItem> sliderItems=new ArrayList<>();
        sliderItems.add(new SliderItem(R.drawable.sixxxone));
        sliderItems.add(new SliderItem(R.drawable.sixtwo));
        sliderItems.add(new SliderItem(R.drawable.sixthree));
