...
public class nutfrag3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_nutfrag3, container, false);
        viewPager3=view.findViewById(R.id.viewPagerImageSliderNutrition3);

        List<SliderItem> sliderItems=new ArrayList<>();
        sliderItems.add(new SliderItem(R.drawable.nineone));
        sliderItems.add(new SliderItem(R.drawable.ninetwo));
        sliderItems.add(new SliderItem(R.drawable.ninethree));
