...
public class nutfrag5 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_nutfrag5, container, false);
        viewPager3=view.findViewById(R.id.viewPagerImageSliderNutrition5);

        List<SliderItem> sliderItems=new ArrayList<>();
        sliderItems.add(new SliderItem(R.drawable.threeone));
